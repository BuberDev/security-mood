      ...
      <Container>
        <div className="grid gap-9 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center">
          ...
          <div className="space-y-6">
            <Badge><T text="Security Mood Pick" /></Badge>
            <h1 className="font-heading text-4xl leading-tight sm:text-5xl md:text-6xl"><T text={product.name} /></h1>
            <p className="max-w-2xl text-base leading-relaxed text-white/85 md:text-lg"><T text={emotionalHook} /></p>
            <p className="max-w-2xl rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm leading-relaxed text-white/80 md:text-base">
              <span className="font-semibold text-white"><T text="Best for:" /></span> <T text={bestFor} />
            </p>
