    ...
    <Card className="overflow-hidden border-white/12 bg-white/[0.02] transition-all duration-300 hover:-translate-y-1 hover:border-accent-gold/60">
      <div className="grid gap-5 p-5 md:p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-xs uppercase tracking-[0.16em] text-accent-gold"><T text="Step" /> {stepNumber}</p>
            <h3 className="mt-2 font-heading text-2xl leading-tight text-text-primary"><T text={stepLabel} /></h3>
          </div>
        ...
        <div className="space-y-2">
          <p className="text-lg font-medium text-text-primary"><T text={product.name} /></p>
        ...
        <p className="inline-flex items-center justify-center gap-2 text-xs uppercase tracking-[0.14em] text-text-secondary">
          <T text="See why this belongs in the kit" />
