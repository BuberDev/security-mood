...
export const products: Product[] = [
  {
    ...
    benefit: "Fingertip security with military-grade precision.",
    description: "A biometric smart lock for your front door, combining a fast fingerprint reader, app-based lock control, and a zinc-alloy body built to military-grade standards.",
  ...
  },
  {
    ...
    categoryId: "home-security",
    benefit: "See everything. Invisible protection, 24/7.",
    description: "An ultra-compact 4K camera with motion detection and night mode that streams live to your phone. Built for discreet monitoring of pets, deliveries, or a spare room.",
    trustSignal: "Popular",
  ...
  },
  {
    ...
    benefit: "Your mobile safe for modern travel.",
    description: "Designed for modern nomads: hidden zippers, an RFID-blocking card pocket, a USB charging port, and cut-resistant material to protect your gear on every trip.",
...
export const productProofById: Record<string, ProductProof> = {
  "biometric-smart-lock": {
    rating: 4.9,
    reviews: "1,200+ positive reviews",
  ...
  "mini-spy-camera-4k": {
    rating: 4.8,
    reviews: "8,500+ satisfied customers",
  ...
  "anti-theft-smart-backpack": {
    rating: 5.0,
    reviews: "Tested by 10,000+ travelers",
